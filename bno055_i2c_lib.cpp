...
bool Bno055I2c::SetOperationMode(uint8_t mode) {
...
int Bno055I2c::ReadRegister(uint8_t reg, uint8_t *data, size_t length) {
...
int Bno055I2c::WriteRegister(uint8_t reg, const uint8_t *data, size_t length) {
